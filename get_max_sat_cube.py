...
iwv = iris.load('single_lvl_data.nc', 'tcwv')[0][0] # IWV
u_ivt = iris.load('single_lvl_data.nc', 'p71.162')[0][0] # Eastward IVT
v_ivt = iris.load('single_lvl_data.nc', 'p72.162')[0][0] # Northward IVT
tp = iris.load('single_lvl_data.nc', 'tp')[0][0] # Total precipitation
sp = iris.load('single_lvl_data.nc', 'sp')[0][0] # Surface pressure
sp.convert_units('hPa') # Convert to hPa
t2m = iris.load('single_lvl_data.nc', 't2m')[0][0] # 2m temperature
t2m.convert_units('Celsius')
d2m = iris.load('single_lvl_data.nc', 'd2m')[0][0] # 2m dewpoint temperature
d2m.convert_units('Celsius')
u10 = iris.load('single_lvl_data.nc', 'u10')[0][0] # 10m u wind
v10 = iris.load('single_lvl_data.nc', 'v10')[0][0] # 10m v wind
# Pressure Level Data
t = iris.load('p_lvl_data.nc', 't')[0][0] # Temperature
t.convert_units('Celsius')
u = iris.load('p_lvl_data.nc', 'u')[0][0] # u wind
v = iris.load('p_lvl_data.nc', 'v')[0][0] # v wind
q = iris.load('p_lvl_data.nc', 'q')[0][0] # Specific humidity
# --------------------------------------------------------------------
...
plot_cube(norm_ivt, "norm_ivt", "normalised ivt", "normalised ivt (figure this out)")